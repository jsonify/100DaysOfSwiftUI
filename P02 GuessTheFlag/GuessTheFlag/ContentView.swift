...
struct ContentView: View {
    // Fixing Guess the Flag from P15-Accessibility
    let labels = [
                ...
                ForEach(0..<3) { number in
                    Button(action: {
                        ...
                        Image(self.countries[number])
                            ...
                            // add text descriptions for each of our flags, describing them in enough detail that they can be guessed correctly by someone who has learned them, but of course without actually giving away the name of the country.
